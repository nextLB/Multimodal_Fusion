...
def create_all_path():
    saveModelPath = os.path.join(config_path.MODEL_PATH, f'maxEpochs_{config_parameters.PRETRAINED_MAX_EPOCHS}_learningRate_{config_parameters.PRETRAINED_LEARNING_RATE}')
    saveLogFilePath = os.path.join(config_path.LOG_FILE_PATH, f'maxEpochs_{config_parameters.PRETRAINED_MAX_EPOCHS}_learningRate_{config_parameters.PRETRAINED_LEARNING_RATE}')
    saveFeatureMapsPath = os.path.join(config_path.FEATURE_MAPS_PATH, f'maxEpochs_{config_parameters.PRETRAINED_MAX_EPOCHS}_learningRate_{config_parameters.PRETRAINED_LEARNING_RATE}')
